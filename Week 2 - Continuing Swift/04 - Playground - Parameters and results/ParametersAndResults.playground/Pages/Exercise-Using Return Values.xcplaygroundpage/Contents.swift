...
let numberCount = impossibleBeliefsCount(pigsFlying: 5, frogsBecomingPrinces: 3, multipleLightningStrikes: 7)

let phrase = impossibleThingsPhrase(numberOfImpossibleThings: 8, meal: "Happy meal")
