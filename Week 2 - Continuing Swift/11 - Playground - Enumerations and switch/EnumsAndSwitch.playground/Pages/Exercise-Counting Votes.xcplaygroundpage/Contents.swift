 ...
 */
func countVotes(votes: [ClassTripDestination]) -> String {
    var countBeachVotes = 0
    var countChocolateFactory = 0
    ...
    return "The beach votes: \(countBeachVotes); The chocolate factory votes: \(countChocolateFactory)"
}

let resultTheVotesTrip = countVotes(votes: tripDestinationVotes)
print(resultTheVotesTrip)
/*:
 ### Extension:
 ...
 */
func countMascotVotes(votes: [SchoolMascotOption]) -> String {
    ...
    return "Salamander: \(salamanderCount); Marmot: \(marmotCount); Neither: \(neitherCount)"
}

let resultTheVotesMascot = countMascotVotes(votes: mascotVotes)
print(resultTheVotesMascot)
