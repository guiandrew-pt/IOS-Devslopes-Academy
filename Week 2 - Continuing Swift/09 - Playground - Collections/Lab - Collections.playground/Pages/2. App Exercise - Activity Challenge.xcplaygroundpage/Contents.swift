 ...
 */
var arrListWalking = [String]()
var arrListRunning = [String]()
/*:
 ...
 */
arrListWalking += ["Walk 3 miles a day", "Walk 5 miles a day", "Walk 10 miles a day"]
arrListRunning += ["Run 5 times a week", "Run 3 times a week", "Run 8 times a week"]

print(arrListRunning[1])
/*:
 All of the challenges will reset at the end of the month. Use the `removeAll` to remove everything from `challenges`. Print `challenges`.
 */
arrListWalking.removeLast()
arrListRunning.removeLast()

print(arrListWalking)
print(arrListRunning)
 ...
 */
var challenges = [arrListWalking, arrListRunning]
print(challenges[1][0])

challenges.removeAll()
print(challenges)

var challengesUser = [String]()
/*:
 Write an if statement that will use `isEmpty` to check if there is anything in the array. If there is not, print a statement asking the user to commit to a challenge. Add an else-if statement that will print "The challenge you have chosen is <INSERT CHOSEN CHALLENGE>" if the array count is exactly 1. Then add an else statement that will print "You have chosen multiple challenges."
 */
if challengesUser.isEmpty {
    print("Commit same challenges!")
} else if challengesUser.count == 1 {
    print("The challenge you have chosen is \(challengesUser[0])")
} else {
