...
*/
var arrLiteral = [1, 3.1, 4, 5.2, 6.8, 3, 9.1, 10, 12.0, 8.3, 7.6, 3.9, 17, 18.6, 19, 20.4, 30.0, 1.8, 2.2, 3.3]
...
func dailyNumber(num: Double) -> String {
    switch num {
        case 1...5:
...
for num in arrLiteral {
    print(dailyNumber(num: num))
}
