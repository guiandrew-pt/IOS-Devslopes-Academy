...
let house = "house"
let sad = "sad"
let depressed = "depressed"
let joy = "joy"

let makeStory = "Today was a big day for \(goalieName). They had finally saved up \(secondHalfSaves) dollars and were going to buy a \(car) \(green). They went to the \(bigHouse) \(house) feeling very \(sad). But then they felt \(depressed). They were all out of \(joy)!"
