...
//var userAge = Int()
//userAge = Int(userInputAge) // Value of optional type 'Int?' must be unwrapped to a value of type 'Int'
// OR:
// let userAge: Int = Int(userInputAge) // Value of optional type 'Int?' must be unwrapped to a value of type 'Int'
...
//print(userAge) // Is nil because of the character "e" in "34e". Can't convert the "e" to Int. It can convert only numbers in a string. Because the string "34e" cointains letters will give the nil.
/*:
...
let userAge: Int? = Int(userInputAge)
print(userAge) // Yes, have the word Optional
print(userAge!)
/*:
