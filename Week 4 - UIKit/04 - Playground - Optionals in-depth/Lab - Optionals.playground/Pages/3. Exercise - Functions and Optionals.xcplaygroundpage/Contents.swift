...
//
//func checkAge(userAgeStr age: String) {
...
//}
//
//checkAge(userAgeStr: userInputAge)
/*:
 Go back and update your function to return the age as an integer. Will your function always return a value? Make sure your return type accurately reflects this. Call the function and print the return value.
 */
let userInputAge: String = "34"

func checkAge(userAgeStr age: String) -> Int? {
    if let userAge: Int = Int(age) {
        if userAge >= 18 {
            print("Welcome!")
        } else {
...
if let value = checkAge(userAgeStr: userInputAge) {
    print(value)
}
...
if let value = purchase(item: "Juice") {
    print(value)
}
