 ...
 */
let ibmPc = Computer(ram: 0, yearManufactured: 1969)
if let ibm = ibmPc {
    print("IBM -> Ram: \(ibm.ram); Year: \(ibm.yearManufactured);")
} else {
    print("Fail")
}

let asusPc = Computer(ram: 16, yearManufactured: 2016)
if let asus = asusPc {
    print("ASUS -> Ram: \(asus.ram); Year: \(asus.yearManufactured);")
} else {
    print("Fail")
}
