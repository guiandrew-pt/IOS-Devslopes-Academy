...
func mealsMenu(meal: String) -> Meal? {
    return meals[meal]
}

print(mealsMenu(meal: "Breakfast") ?? "Working progress!")
print(mealsMenu(meal: "Dinner") ?? "Working progress!")
/*:
...
func mealLog() -> [String: Any]? {
    if let info = UserDefaults.standard.dictionary(forKey: "meallog") {
        return info
    }
